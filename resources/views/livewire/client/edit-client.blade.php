<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8 flex justify-between items-start">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Modifier le Client</h1>
            <p class="mt-2 text-gray-600 dark:text-gray-400">Modifiez les informations du client ci-dessous.</p>
        </div>
